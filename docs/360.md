...
<figure class="aligncenter">[![Java Quiz](../Images/88a945cc9a3680018fa7721831c88ae1.png)](https://www.softwaretestingmaterial.com/java-quiz/)</figure>

## **Selenium 自动化框架中 OOPS 的概念**

在这篇文章中，我们将讨论在自动化框架中如何以及在哪里应用 OOPs 概念。

<nav class="wp-block-kadence-tableofcontents kb-table-of-content-nav kb-table-of-content-id_179128-36 kb-toc-smooth-scroll kb-collapsible-toc kb-toc-toggle-active" role="navigation" aria-label="Table Of Contents" data-scroll-offset="40">Table of Contents <button class="kb-table-of-contents-icon-trigger kb-table-of-contents-toggle" aria-expanded="true" aria-label="Collapse Table of Contents">*   [Selenium 自动化框架中 OOPS 的概念](#concepts-of-oops-in-selenium-automation-framework)
    *   [#1。抽象](#ABSTRACTION)
    *   [#2。接口](#INTERFACE)
    *   [#3。继承](#INHERITANCE)
    *   [#4。多态性](#POLYMORPHISM)
...
*   [其他 Selenium 自动化框架概念](#other-selenium-automation-framework-concepts)
    ...
    *   [#3。按](#3-find-by)查找
    *   [#4。查找元素](#4-find-element)</button> </nav>

<figure class="aligncenter">[![OOPS in Automation Framework](../Images/f6fb6f1c8672e55d053d261d435c31fc.png)](https://www.softwaretestingmaterial.com/wp-content/uploads/2018/04/OOPS-in-Automation-Framework.png)</figure>
