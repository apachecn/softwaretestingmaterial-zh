...
<figure class="aligncenter">![Postman Tutorial](../Images/397219118ff573e37f40f59f75e000c7.png)</figure>
...
*   [什么是邮递员？](#h-what-is-postman)
*   [为什么是邮递员？](#h-why-postman)
*   [邮递员安装:](#h-postman-installation)
*   [邮递员功能:](#h-postman-features)
*   [如何使用邮递员](#h-how-to-use-postman)
...
<figure class="aligncenter">![Postman Workspace](../Images/b4622b4f026f3b183399a49daccdd82c.png)</figure>

1.New:创建一个新的请求、集合或环境。
2。导入:就是导入一个集合或者环境。您还可以找到其他选项，如从文件、文件夹、链接或粘贴原始测试导入。
3。Runner:我们可以使用 Collection Runner 来执行自动化测试。
4。打开新的:我们可以打开邮递员窗口或邮递员窗口
...
<figure class="aligncenter">![Postman New Request](../Images/5846d07657e15301b85b0ffae98134ef.png)</figure>

<figure class="aligncenter">![Postman New Get Request](../Images/f9704320ee387398dffcbeac2b7e3691.png)</figure>

<figure class="aligncenter">![Postman Save Request](../Images/b6a0da7a2fce5208e8d560c0cd3e0b04.png)</figure>
...
<figure class="aligncenter">![Postman New Collection](../Images/7a88da7f9e8defa964b2f99db9d993c6.png)</figure>

输入集合名称和描述，然后单击创建以创建新集合

<figure class="aligncenter">![Postman Create New Collection](../Images/11163e4bc30c22b540dd434d59be3562.png)</figure>
...
<figure class="aligncenter">![Postman New Environment](../Images/9b169e50e6eda1605bbfebd16290125e.png)</figure>

<figure class="aligncenter">![Postman Create New Environment](../Images/6491c31089de86c4b19ed16e26059e2b.png)</figure>
...
<figure class="wp-block-embed">https://jsonplaceholder.typicode.com/users</figure>
...
<figure class="aligncenter">![Postman Response Time](../Images/8e8a4234665275fd200b841c62ea7185.png)</figure>

**响应大小:**我们可以看到单个组件，比如实际的响应大小、头的大小等等。,

<figure class="aligncenter">![](../Images/440a6a98a9075ffab0e10f1608d2bb17.png)</figure>

**cookie:**我们可以在服务器返回的 cookie 中找到会话相关信息。

<figure class="aligncenter">![Postman GET Request Cookies](../Images/1d12cf65a49893b6db0914490046abb7.png)</figure>

**Response header:** 在这里，我们可以找到关于已处理请求的信息。

<figure class="aligncenter">![Postman GET Request Header](../Images/68d96b42d6cb541bb2fdae21a82571b4.png)</figure>
...
<figure class="aligncenter">![Postman POST Request](../Images/b940b64fb3156973f87a0e725f322abe.png)</figure>

1.  您可以在下面的截图中看到 **201 创建的消息**，因为我们的请求成功了。
2.  你可以在正文中看到发布的数据。

<figure class="aligncenter">![Postman POST Response](../Images/8b00c1fcb2a0ae9a58b357221fe17478.png)</figure>
...
例如，我有一个 **base URL** 比如说**并且我已经存储在一个名为 ***base_url*** 的变量中。在这种情况下，我使用 ***{{base_url}}*** 在我的请求中引用它。向该基本 URL 发送请求(即，***https://stm.org***)为了获取新客户列表，我使用 ***{{base_url}}/get？**客户=新*。该请求将由邮递员发送到***https://stm.org/get?customers=new***。**

**1.设置 HTTP 请求以获取并输入 URL**

<figure class="aligncenter">**![Postman Parameterize GET URL](../Images/e362cb744cb9ce00df05ba0ba0cc56c7.png)**</figure>

**2.将 URL 替换为参数，如 ***{{url}}*** 。请求 URL 应该是***{ { URL } }/用户*** 。**

<figure class="aligncenter">**![Postman Parameterize GET URL](../Images/8d0730cf4716d2c875f588797a491c09.png)**</figure>

**3.现在我们需要设置环境变量来设置参数。为此，单击眼睛图标，然后单击编辑，将变量设置为全局环境变量，以便在所有集合中使用它**

<figure class="aligncenter">**![Postman Environment Variables](../Images/bf0894f20eea10b8921868ac9d3c700d.png)**</figure>

**4.在变量中，将名称设置为 url，即 https://jsonplaceholder.typicode.com，然后单击保存。**

<figure class="aligncenter">**![Postman Global Variables](../Images/5b75b90950b9a2a439309854ba2f60e1.png)**</figure>

**注意:如果看到下一个屏幕，请单击“关闭”**

**5.返回获取请求，然后单击发送。**

<figure class="aligncenter">**![Postman Parameterization](../Images/836a892a8131dff64115bb6e59d8ca99.png)**</figure>
...
<figure class="aligncenter">**![Postman Tests](../Images/67c4a719ff8005b37b553be8152d7e08.png)**</figure>

**2.点击发送。将显示结果。**

<figure class="aligncenter">**![Postman Tests Result](../Images/c4f7c4723774b43c2c75cd083762f12e.png)**</figure>

**3.让我们添加另一个测试。在这个测试中，我们将预期结果与实际结果进行比较。为此，在 snippets 部分点击“响应体:JSON 值检查”。让我们检查一下符晓薇·格拉汉姆是否有用户标识 1。**

<figure class="aligncenter">**![Postman Tests Expected Actual Results](../Images/b4c05b5a3ca08dd10ffd58cb4a5b8b36.png)**</figure>
...
<figure class="aligncenter">**![Postman Tests Expected Actual Results](../Images/c1361c2bc69576925126a466943fccfc.png)**</figure>
...
<figure class="aligncenter">**![Postman Tests Expected Actual Results Report](../Images/7b115943f23f455beb48e6d2e50373de.png)**</figure>
...
<figure class="aligncenter">**![Postman Runner Collection](../Images/5b579a5589fa04a60b7b0b0ce2bfe4cf.png)**</figure>

**2.应该会出现收款员页面**

<figure class="aligncenter">**![Postman Collection Runner Details](../Images/9b4040ee3cdc0f626eedefb864721282.png)**</figure>
...
<figure class="aligncenter">**![Postman Collection Runner Example](../Images/39a8124bff620a761232b3d941c6d619.png)**</figure>

**4.您可以在测试执行后看到测试状态。这里我们添加了 GET 和 POST 请求，但是没有 POST 请求。因此，您会看到一条关于 POST 请求的消息，显示为“该请求没有任何测试”。**

<figure class="aligncenter">**![Postman Collection Runner Report](../Images/b35b8f715a4075f28d91a8007740fee6.png)**</figure>
...
<figure class="aligncenter">**![Postman Newman](../Images/0a73dd1d8d52497b252c7ca4e03197e3.png)**</figure>

 **4。选择将集合导出为集合 v2.1(推荐)，然后单击导出。**

<figure class="aligncenter">**![Postman Newman](../Images/a511fca820a9d55f02a00cbbea22f28b.png)**</figure>
...
<figure class="aligncenter">**![Postman Newman Global Variables](../Images/5b75b90950b9a2a439309854ba2f60e1.png)**</figure>

<figure class="aligncenter">**![](../Images/b07ad62dcfc6486a9938a346a6c9be48.png)**</figure>
...
*   #### **[**API 测试用例在邮递员中使用 JavaScript**](https://www.softwaretestingmaterial.com/api-test-cases-in-postman-using-javascript/)T5】**
...
*   **[**在邮递员**测试 OAuth2 授权](https://www.softwaretestingmaterial.com/testing-oauth2-authorization-in-postman/)**
*   **[**如何发送 JSON Web Token (JWT)作为头**](https://www.softwaretestingmaterial.com/how-to-send-jwt-token-as-header/)**
*   **[**JSON 模式验证在邮递员**T3】](https://www.softwaretestingmaterial.com/json-schema-validation-in-postman/)**
*   **[**邮递员**](https://www.softwaretestingmaterial.com/data-driven-testing-in-postman/) 中的数据驱动测试**
*   **[**在邮递员**中监控集合](https://www.softwaretestingmaterial.com/monitor-collections-in-postman/)**
...
*   **[**如何修复邮递员**](https://www.softwaretestingmaterial.com/how-to-fix-common-errors-in-postman/) 常见错误**
*   **邮递员中的 GUID**
